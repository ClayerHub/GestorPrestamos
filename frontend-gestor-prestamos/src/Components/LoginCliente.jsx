...
function LoginCliente({ setUserRole }) {  // Recibiendo 'setUserRole' como prop
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data && response.data.rol === 'cliente') {
                // Si el rol es 'cliente', redirigir a la página de funcionalidades del cliente
                setUserRole('cliente'); // Actualiza el rol del usuario
                navigate('/menu-cliente');  // Redirige al cliente a su página principal
            } else {
